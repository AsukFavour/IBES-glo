        ...
        init: function () {
          $("#datatable-buttons").length &&
            $("#datatable-buttons").DataTable({
              dom: "Blfrtip",
              buttons: [
                { extend: "copy", className: "btn-sm btn-outline-success" },
                { extend: "csv", className: "btn-sm btn-outline-success" },
                { extend: "excel", className: "btn-sm btn-outline-success" },
                { extend: "pdfHtml5", className: "btn-sm btn-outline-success " },
                { extend: "print", className: "btn-sm btn-outline-success" },
              ],
              responsive: !0,
            });
        },
